...
ALTER TABLE "public"."feriados" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE "public"."tipos_ocorrencia" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."tipos_ocorrencia_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."ocorrencias" (
    "id" bigint NOT NULL,
    "colaborador_id" "uuid" NOT NULL,
    "colaborador_cliente_id" bigint, -- Opcional: Vinculo com o turno
...
ALTER TABLE "public"."ocorrencias" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."ocorrencias_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE IF NOT EXISTS "public"."permissoes_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS "public"."fechamentos_financeiros" (
    ...
    "resumo_json" "jsonb" NOT NULL, -- Snapshot total do resumo calculado
...
ALTER TABLE "public"."fechamentos_financeiros" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."fechamentos_financeiros_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."permissoes"
    ADD CONSTRAINT "permissoes_nome_interno_key" UNIQUE ("nome_interno");
...
CREATE INDEX "idx_ocorrencias_vínculo" ON "public"."ocorrencias" USING "btree" ("colaborador_cliente_id");
...
ALTER TABLE ONLY "public"."fechamentos_financeiros"
    ADD CONSTRAINT "fk_fechamento_colaborador" FOREIGN KEY ("colaborador_id") REFERENCES "public"."usuarios"("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."fechamentos_financeiros"
    ADD CONSTRAINT "fk_fechamento_fechador" FOREIGN KEY ("fechado_por") REFERENCES "public"."usuarios"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."perfil_permissoes"
    ADD CONSTRAINT "fk_perfil_permissoes_perfil" FOREIGN KEY ("perfil_id") REFERENCES "public"."perfis"("id") ON UPDATE CASCADE ON DELETE CASCADE;


ALTER TABLE ONLY "public"."ocorrencias"
    ADD CONSTRAINT "fk_ocorrencia_colaborador" FOREIGN KEY ("colaborador_id") REFERENCES "public"."usuarios"("id") ON DELETE CASCADE;


ALTER TABLE ONLY "public"."ocorrencias"
    ADD CONSTRAINT "fk_ocorrencia_tipo" FOREIGN KEY ("tipo_id") REFERENCES "public"."tipos_ocorrencia"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."perfil_permissoes"
    ADD CONSTRAINT "fk_perfil_permissoes_permissao" FOREIGN KEY ("permissao_id") REFERENCES "public"."permissoes"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."fechamentos_financeiros" TO "anon";
GRANT ALL ON TABLE "public"."fechamentos_financeiros" TO "authenticated";
GRANT ALL ON TABLE "public"."fechamentos_financeiros" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."fechamentos_financeiros_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."fechamentos_financeiros_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."fechamentos_financeiros_id_seq" TO "service_role";
